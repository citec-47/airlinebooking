...
<nav class="navbar navbar-expand-lg navbar-light " >
      <div class="container">
		...
		<form action="cancel_booked_tickets_form_handler.php" method="post">
			<h2 style="text-align: center;margin-bottom: 50px;color: red;">CANCEL BOOKED TICKETS</h2>
			<?php
				if(isset($_GET['msg']) && $_GET['msg']=='failed')
				{
					echo "<strong style='color: red;text-align: center;display: block;font-size: 20px;'>Successfully cancel yor flight</strong>
						<br>
						<br>";
				}
			?>
